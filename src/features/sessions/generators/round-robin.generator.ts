/**
 * Placeholder generator for the Round Robin format.
 * The fixed-team, all-vs-all fixture algorithm (docs/tournament-formats/round-robin.md)
...
export class RoundRobinGenerator implements TournamentGenerator {
  ...
  async generate(_plan: TournamentPlan, _context: GeneratorContext): Promise<GeneratorResult> {
    return { status: 'not-implemented', message: 'RoundRobinGenerator.generate is not implemented yet.' }
  }
  ...
  async regenerate(
    ...
    return { status: 'not-implemented', message: 'RoundRobinGenerator.regenerate is not implemented yet.' }
  }

  validate(_plan: TournamentPlan, _context: GeneratorContext): GeneratorValidationResult {
    return { valid: false, errors: ['RoundRobinGenerator is not implemented yet.'] }
  }
